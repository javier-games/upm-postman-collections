...
namespace BricksBucket.Web.Postman
{
	...
	public class Variable
	{
		...
		/// <summary>
		/// A variable may have multiple types. This field specifies the type
		/// of the variable.
		/// </summary>
		...
		/// <summary>
		/// When set to true, indicates that this variable has been set by
		/// Postman
		/// </summary>
